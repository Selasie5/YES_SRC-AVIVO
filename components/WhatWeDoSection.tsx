      ...
      <div className="flex flex-col gap-6 md:flex-row">
        {services.map((service, index) => (
          <div
            ...
            className={`min-w-0 transition-all duration-500 ease-in-out md:flex ${hoveredIndex !== null && hoveredIndex !== index ? "md:flex-[0.6]" : ""
              } ${hoveredIndex === index ? "md:flex-[2]" : ""} ${hoveredIndex === null ? "md:flex-1" : ""
              }`}
          >
