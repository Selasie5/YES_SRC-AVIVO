...
export default function ServiceCard({ title, description, image, gradient }: ServiceCardProps) {
  return (
    ...
    >
      ...
      <span className="z-10 mb-4 inline-flex items-center p-6 pb-20 text-xl font-medium text-white drop-shadow-md font-[family-name:var(--font-inter-tight)] sm:p-8 sm:text-[1.35rem] sm:pb-28">
        {title}
      </span>
      
      <div className="absolute bottom-4 left-4 right-4 z-10 flex items-start gap-4 bg-white p-4 opacity-100 transition-all duration-500 ease-in-out sm:bottom-6 sm:left-6 sm:right-6 sm:p-5 md:opacity-0 md:group-hover:opacity-100">
